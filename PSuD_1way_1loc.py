...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description=__doc__)
    parser.add_argument(
                        '-a', '--audioFiles', default=[],action="extend", nargs="+", type=str,
                        help='Choose audiofiles to use for test.')
    parser.add_argument('-t', '--trials', type=int, default=test_obj.trials,
                        help='Number of trials to use for test. Defaults to %(default)')
    ...
    parser.add_argument('-b', '--blockSize', type=int, default=test_obj.blockSize,
                        help='Block size for transmitting audio (default: %(default)s)')
    parser.add_argument('-q', '--bufferSize', type=int, default=test_obj.bufSize,metavar='bufSize',
                        help='Number of blocks used for buffering audio (default: %(default)s)')
    parser.add_argument('-p', '--overPlay', type=float, default=test_obj.overPlay, 
                        ...
                        ' in the system')
    parser.add_argument('-o', '--outdir', default='', help='Directory that is added to the '+
